    ...
    <div className="flex flex-col bg-background">
      ...
      <section className="py-10 px-4 bg-navy text-ivory">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide gap-3 pb-2 -mx-4 px-4">
          {[
            { img: "https://res.cloudinary.com/dmp1d9o5w/image/upload/v1783105462/4fd50618-4db3-4a85-9587-37875489df7a_hbka2w.png", text: "Advanced Equipment" },
            { img: "https://res.cloudinary.com/dmp1d9o5w/image/upload/v1783103787/reception_wk1y5d.png", text: "Premium Interiors" },
            { img: "https://res.cloudinary.com/dmp1d9o5w/image/upload/v1783105666/7cefd7a2-a8bf-41e1-8833-8e945c08c746_cfwugr.png", text: "Modern Sterilization" }
          ].map((c, i) => (
